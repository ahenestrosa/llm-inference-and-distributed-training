...
| **Quantization type** | W4A16 (dequantize W→FP16 for matmul) | W4A16 (dequantize W→FP16 for matmul) | W8A8 + FP16 outliers (INT8 matmul for ~99.9% of dims, FP16 matmul for outlier dims) | W4A16 (dequantize W→BF16 for matmul) | W4A16 on GPU (dequantize W→FP16 for matmul); W4A32 on CPU (dequantize W→FP32) |
